class AppTranslations {
  static const Map<String, Map<String, String>> _translations = {
    ...
    'instruction_3': {
      'fr': 'Les onglets Exercices et Aliments utilisent les vraies données de la base',
      'en': 'The Exercises and Foods tabs use real database data',
    },
    'instruction_4': {
      'fr': 'La langue sélectionnée est sauvegardée et persiste entre les sessions',
    ...
    'ai_tip_hydration': {
      ...
      'en': '💡 Tip: Drink a glass of water before each meal for better digestion and satiety.',
    },
    'ai_tip_timing': {
      'fr': '⏰ Timing parfait : Consommez vos protéines dans les 30 minutes après l\'entraînement.',
      'en': '⏰ Perfect timing: Consume your proteins within 30 minutes after training.',
    },
    'ai_tip_balance': {
      'fr': '⚖️ Équilibre : Votre ratio protéines/glucides est optimal pour votre objectif.',
    ...
    'start_adding_foods': {
      'fr': 'Commencez à ajouter des aliments à vos repas\npour voir vos suggestions ici',
    ...
    'enter_nutrients': {
      'fr': 'Veuillez entrer au moins une valeur nutritionnelle (protéines, glucides ou lipides).',
      'en': 'Please enter at least one nutritional value (protein, carbs, or fats).',
    },
    'error_creating_food': {
