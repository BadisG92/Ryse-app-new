...
class AppTranslations {
  static const Map<String, Map<String, String>> _translations = {
    ...
    'settings_theme_hint': {
      'fr': 'Quatre éditions, chacune avec son fond',
      'en': 'Four editions, each with its own ground',
      'de': 'Vier Editionen, jede mit eigenem Grund',
    },
    'theme_nuit': {'fr': 'Nuit', 'en': 'Night', 'de': 'Nacht'},
    'theme_cerise': {'fr': 'Cerise', 'en': 'Cherry', 'de': 'Kirsche'},
    'theme_volt': {'fr': 'Volt', 'en': 'Volt', 'de': 'Volt'},
    'theme_sable': {'fr': 'Sable', 'en': 'Sand', 'de': 'Sand'},
    'chat_copied': {
      'fr': 'Message copié',
      'en': 'Message copied',
