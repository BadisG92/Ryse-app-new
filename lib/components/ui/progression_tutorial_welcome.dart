...
/// Écran de bienvenue du tutorial Progression
class ProgressionTutorialWelcome extends StatefulWidget {
  final String languageCode;
  final String? userName;
  final VoidCallback onStart;
  final VoidCallback onSkip;

  const ProgressionTutorialWelcome({
    Key? key,
  ...
  @override
  State<ProgressionTutorialWelcome> createState() => _ProgressionTutorialWelcomeState();
}

class _ProgressionTutorialWelcomeState extends State<ProgressionTutorialWelcome>
