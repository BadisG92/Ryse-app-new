...
class _NutritionJournalHybridState extends State<NutritionJournalHybrid> {
  ...
  // REMOVED: _showAddFoodBottomSheet() and _showAddFoodBottomSheet_OLD() - unused methods
  // Use NutritionQuickActionsSection.showMealSelectionForManualEntry(context) instead
